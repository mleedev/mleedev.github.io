  ...
  return (
    <div className="App">
      ...
      <main className=''>
        ...
        <p>I'm Matthew Lee, a passionate software engineer and technology enthusiast with a deep-rooted interest in solving complex problems through code. With a background in Computer Science from California State University, Long Beach, I've honed my skills in various areas, including software development, web technologies, and data-driven applications.</p>
